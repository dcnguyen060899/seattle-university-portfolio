...
Exactly nine files may be edited:
...
| `index_business_card.html`, `index_data5100_project.html`, `index_image_classification.html`, `learning_algorithm.html` | the Seattle U mark in the header. All six SU-marked pages now link it to the M.S. Data Science programme (2026-09-11); four of them pointed at a departmental page and two at the portfolio, which the header already links |
