...
const MCPTools = (function() {
    ...
    const projects = [
        {
            ...
            description: "AI-powered chatbot for Canadian immigration and settlement services. Built with SFU Blueprint for MOSAIC, an organisation that recorded 660,000 website visits in its 2022 annual report.",
            impact: "Recognized as Top 4 in SFU CS Diversity Award. Built to handle complex immigration queries in natural language.",
            technologies: ["Python", "Neo4j", "NLP", "Knowledge Graphs", "RAG"],
            highlights: [
                "Built a structured query categorization system from real user queries",
                "Designed knowledge graph mapping programs, services, and eligibility criteria",
                "Built a validation pipeline with full lineage tracking",
                "Partnered with legal/operations teams to codify domain requirements"
            ],
            links: { demo: "index_mosaic_chatbot.html" },
            type: "featured",
            metrics: { value: "Top 4", label: "SFU CS Diversity Award" }
        },
        {
            ...
            highlights: [
                ...
                "Analyzed the patient-records dataset to identify key predictive factors",
        ...
        },
        {
            ...
            highlights: [
                "Explained 95.9% of fuel-consumption variance (R² = 0.959) across 312 flights",
    ...
    const experience = [
        ...
        },
        {
            ...
            startDate: "2024-01",
            endDate: "2024-12",
            description: "AI Engineer on the SFU Blueprint student team that built the MOSAIC immigration and settlement chatbot.",
            highlights: ["Top 4 SFU CS Diversity Award", "Knowledge graph development", "Validation pipeline with lineage tracking"]
        },
        {
            type: "volunteer",
    ...
    // Availability corrected 2026-09. The block that used to sit here named a
    // 2026 internship season and a mid-2026 start date. Both were stale, and the
    // earlier season string is on the project's hard-fail retraction list, so it
    // is not repeated here.
    //
    // The M.S. is 45 credits plus a two-quarter capstone (DATA 5901 + DATA 5902)
    // and finishes in June 2027, so the earliest availability is Summer 2027.
    // The target is BOTH: a Summer 2027 internship AND a new-grad research /
    // data-science / ML-engineering role starting mid-2027. `roles` is widened
    // to match, because an intern-only list contradicts the "both" position that
    // `seeking` now states.
    const availability = {
        seeking: "Summer 2027 internship, or a new-grad role starting mid-2027",
        roles: ["Research Scientist", "Data Scientist", "ML Engineer", "Data Engineer"],
        startDate: "June 2027",
